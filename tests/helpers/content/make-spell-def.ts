 ...
 * from three Quartz, aimed at a point, a short cast point, flat cooldown and mana tables
 * of one entry per orb level, and no effects. A spec overrides what it is about.
 */
