...
| A new spell, effect, or enemy ability | [Ability pipeline](./architecture/ability-pipeline.md#quick-reference) · [Content and registries](./architecture/content-and-registries.md#quick-reference) · [Adding a spell](./workflows/adding-a-spell.md) |
...
**Product** — [overview](./product/overview.md) · [roadmap](./product/roadmap.md) · [vocabulary](./product/vocabulary.md) · [features](./product/features/README.md) · [mechanics spec](./product/specs/character-movement-and-mechanics.md)
