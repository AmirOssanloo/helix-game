...
- [The long road](./specs/the-long-road.md) — the long road as data: the rectangle, five regions, every pack with its archetype, tier, count, and position, the chokes and blocks, the checkpoints, and the experience budget from level 1 to level 10 at the last boss. The map definition is written from it
