...
- **Attack and aggro ranges** — the hero's attack range to a target's edge and its acquire radius; each enemy's aggro radius around it and leash radius around the point its leash is measured from, its spawn point unless a hit woke it on its way home.
