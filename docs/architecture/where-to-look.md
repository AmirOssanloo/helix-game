...
| How damage lands, what a hit's statuses do about it, and how a unit dies and respawns | `src/domain/combat/` — the damage rule, the damage hooks, and the death system |
