...
| `content/` | Typed data | One file per spell, enemy ability, enemy, status, and map; the hero; the tuning table; the atlas frame list; a registry that assembles and validates them |
