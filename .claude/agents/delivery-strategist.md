...
- **The Staff Engineer's Path** by Tanya Reilly — leading complex work without relying on title alone, being the technical glue between architecture, implementation, design, and content, setting direction, managing stakeholders, and turning ambiguous “make it feel like the genre standard / a simpler the reference game” goals into owned outcomes.
