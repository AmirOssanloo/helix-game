...
| Draw-call readout agrees with the WebGL inspector on one bench frame | Agrees. Spector.js in Chrome on the Apple M1 laptop, by the maintainer, 2026-09-21. Bench: the inspector counted 87 `drawElements` over 84 frames, one per frame with three frames of two, against a readout of 1, which shows the last frame's count. Game with 300 units and the collision and bound overlays on: two draws per frame, a 7284-index world draw and then a 264-index HUD draw, against the panel's 2 total, 1 world |
