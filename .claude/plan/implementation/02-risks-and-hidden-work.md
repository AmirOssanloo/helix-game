...
| R3 | Disc push-out jitters or tunnels at a 50-unit pile-up in the corridor | S03, again S15 | Packs in corridors look broken; ADR 0002 names this as owned code | Capped passes starting at three; a corridor pile-up simulation test; half a day of buffer in S15 for it | P1-S03-T02, P3-S15-T04 |
...
| R10 | Draw calls cannot be read from the Phaser 4 renderer without touching internals | S06 | The draw-call readout lies or does not exist; ADR 0001's gate is unverifiable from the panel | Spike in S06; fallback is the browser's WebGL inspector at gates and the readout marked "unavailable" | P1-S06-T02 |
