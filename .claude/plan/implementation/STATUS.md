...
| **Next ticket** | P2-S09-T01 — The projectile entity and system, the spawn-projectile primitive |
| **In progress** | none |
| **Last closed ticket** | P2-S08-T04 — Statuses on screen: icons and greyed keys, 2026-09-22: every status has an icon frame of its own with a glyph in it, a row of icons rides above each unit that wears one at the text band, the bar greys six squares under a silence or a stun and none under a disarm, and the mapper shuts a cursor the hero may no longer commit |
