...
| **Next ticket** | P2-S09-T02 — Summons: the spawn-unit primitive, ownership, lifetime |
| **In progress** | none |
| **Last closed ticket** | P2-S09-T01 — The projectile entity and system, the spawn-projectile primitive, 2026-09-22: a projectile flies its bearing or follows the unit it homes on, sweeps the segment it crossed against the discs the hash proposes so nothing small slips between two ticks, stops where it touched and runs its hit list there, expires on its range or on a target that is gone, and is drawn as a turned disc at the projectiles band |
