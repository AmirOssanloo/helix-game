...
| **Next ticket** | P1-S04-T03 — The cooldown pipeline and the ten stub spell definitions |
| **In progress** | none |
| **Last closed ticket** | P1-S04-T02 — The Invoke kit: orb buffer, composer, slots, hidden clocks |
