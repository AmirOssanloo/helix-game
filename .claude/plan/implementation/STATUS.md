...
Coming up in sprint 06, each on the ticket that names it: a five-minute session recorded with the panel open (T03), and the phase gate's four-browser run at 300 units with the walk-through repeated in the arena (T04).
