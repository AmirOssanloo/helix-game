...
| Sized versus actual | To date: sized 16.05 days, 16 planned and 0.05 unplanned (P5-S22-T05). Sprints 19 to 21 took 1.6, 1.1, and 1.4 against 4 each. Sprint 22 has taken 0.75 so far, T01 at 0.3, T02 at 0.4, and T05 at 0.05, against 4.05. That is 4.85 actual against the 13.05 sized for the work done, a ratio of 0.37 | the engineer running the plan |
