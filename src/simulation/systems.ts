 ...
 * commands produced. Pathing runs next, so an order consumed this tick has its path before
 * movement reads it. Movement follows, so an order consumed this tick turns or translates
