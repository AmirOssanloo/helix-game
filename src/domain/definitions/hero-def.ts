 ...
 * created, and how it levels. The experience table is indexed from level one with one entry
 * per level up to the cap, each the total experience a hero at that level has reached; the
