 ...
 * the spatial hash's cell size is world units, and the Whorl table holds a fraction of one per
 * instance at each level. The world converts the table into per-tick rates, ticks, and radians
